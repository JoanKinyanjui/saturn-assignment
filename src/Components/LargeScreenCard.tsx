...
<div className='w-full  rounded-[20px] grid p-5 bg-white h-[max-content] mt-5 '>
 ...
 <div className='flex gap-5 items-start'>
         ...
         <div className='w-[40%] xl:w-full  grid gap-5 '>
            <div className='w-full h-[400px] lg:h-[507px] border relative'><Image src='/assets/image.png'  alt='maps' layout='fill' className='w-[100%] h-[100%]'/></div>
            <div className='flex gap-5 justify-between'>
           <div className='w-full h-[100px] lg:h-[161px] border relative'><Image src='/assets/image2.jpg'  alt='maps' layout='fill' className='w-[100%] h-[100%]'/></div>
           <div className='w-full h-[100px] lg:h-[161px] border relative'><Image src='/assets/image3.jpg'  alt='maps' layout='fill' className='w-[100%] h-[100%]'/></div>
           <div className='w-full h-[100px] lg:h-[161px] border relative'><Image src='/assets/image4.png'  alt='maps' layout='fill' className='w-[100%] h-[100%]'/></div>
            </div>
         </div>
         {/* Content */}
         <div className='w-[60%] xl:w-full grid h-[520px]  lg:h-[max-content] overflow-y-auto '>
           ...
           <div className='grid lg:flex items-start gap-5  mt-5 '>
            <div className='grid w-full lg:w-[60%]   '>
               <div className='grid w-full  '>
                  <div className='flex items-center '>
                     <div className='grid gap-2.5 border-r-[1.5px] border-[#EEEEEE] items-start w-1/3 h-full pr-2 lg:pr-5 '>
                        <p className='text-[#B27E02] font-medium md:text-[16px] xl:text-[20px] font-poppins '>₹ 1.4 Cr</p>
                        <p className='text-[12px] text-[#6B6B6B] font-[400] font-poppins'>(₹ 6,990 / Sq  Ft )</p>
                     </div>
                     <div className='grid gap-2.5 border-r-[1.5px] border-[#EEEEEE] h-full  w-1/3 px-2 xl:px-5 '>
                     ...
                     <div className='grid gap-2.5  w-1/3 h-full px-2  lg:px-5'>
                        <div className='flex gap-2 items-center'>
                  ...
                  <div className='flex'>
                     <div className='grid  border-r-[1.5px] border-[#EEEEEE] items-center h-full  w-1/3 pr-2 xl:pr-5 '>
            ...
            <div className='w-full lg:w-[40%] h-[300px] lg:h-full border'>
